scnShortcodeMeta = {
	attributes : [
			...
			},
			{
				label : "Animation",
				id : "animation",
				help : "Select button can be animate or none.",
				controlType : "select-control",
				selectValues : [ '', 'no-animate' ],
				defaultValue : '',
				defaultText : 'Animate (Default)'
			},
			{
				label : "Link",
				id : "link",
			...
			},
			{
				...
				controlType : "select-control",
				selectValues : [ '','avocado','black','blue','blueiris','blueturquoise','brown','burntsienna','chillipepper','emerald','eggplant','electricblue','graasgreen','grey','green','orange','palebrown','pink','radiantorchid','red','skyblue','violet','wetasphalt','yellow'],
				defaultValue : '',
				defaultText : 'Select'
			},
			{
