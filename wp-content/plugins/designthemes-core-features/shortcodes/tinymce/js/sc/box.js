scnShortcodeMeta = {
	attributes : [
			...
			},
			{
				...
				controlType : "select-control",
				selectValues : [ '','avocado','black','blue','blueiris','blueturquoise','brown','burntsienna','chillipepper','emerald','eggplant','electricblue','graasgreen','gray','green','orange','palebrown','pink','radiantorchid','red','skyblue','violet','wetasphalt','yellow', 'ferngreen', 'chocolate', 'coral'],
				defaultValue : '',
				defaultText : 'Select'
			},
			{
