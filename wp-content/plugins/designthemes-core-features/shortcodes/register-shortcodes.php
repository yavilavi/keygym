	...
	class DTCoreShortcodes {
		...
		function dt_init() {
			...
			if (! is_admin ()) {
				...
				wp_enqueue_script ( 'dt-sc-inview-script', plugin_dir_url ( __FILE__ ) . 'js/jquery.inview.js', array (), false, true );
				...
				wp_enqueue_script ( 'dt-sc-touchswipe-script', plugin_dir_url ( __FILE__ ) . 'js/jquery.touchSwipe.min.js', array (), false, true );
