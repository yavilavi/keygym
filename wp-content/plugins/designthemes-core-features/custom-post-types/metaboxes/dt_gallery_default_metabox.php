...
<?php 
$sb_layout = array_key_exists("layout",$gallery_settings) ? $gallery_settings['layout'] : 'content-full-width';
...
<div id="widget-area-options" <?php echo $sidebar_both;?>>
	<div id="left-sidebar-container" class="page-left-sidebar" <?php echo $sidebar_left; ?>>
		...
		<div id="page-commom-sidebar" class="sidebar-section custom-box">
			...
			<div class="column five-sixth last"><?php 
				$switchclass = array_key_exists("disable-everywhere-sidebar-left",$gallery_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
				$checked = array_key_exists("disable-everywhere-sidebar-left",$gallery_settings) ? ' checked="checked"' : '';?>
		...
		<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
			...
			<div class="column five-sixth last"><?php
				if( array_key_exists('widget-area-left', $gallery_settings)):
					$widgetareas =  array_unique($gallery_settings["widget-area-left"]);
	...
	<div id="right-sidebar-container" class="page-right-sidebar" <?php echo $sidebar_right; ?>>
		...
		<div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
			...
			<div class="column five-sixth last"><?php 
				$switchclass = array_key_exists("disable-everywhere-sidebar-right",$gallery_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
				$checked = array_key_exists("disable-everywhere-sidebar-right",$gallery_settings) ? ' checked="checked"' : '';?>
		...
		<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
			...
			<div class="column five-sixth last"><?php
				if( array_key_exists('widget-area-right', $gallery_settings)):
					$widgetareas =  array_unique($gallery_settings["widget-area-right"]);
					$widgetareas = array_filter($widgetareas);
					foreach( $widgetareas as $widgetarea ){
						echo '<div class="multidropdown">';
