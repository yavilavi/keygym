        	...
        	<div id="header-wrapper" class="<?php if(dt_theme_option('general','header-top-bar') == "true") echo esc_attr('notop-bar'); if($htype == 'header3') echo esc_attr(' header3-wrapper'); ?>">
				...
				if($htype == 'header3'): ?>
                    <div id="logo"><?php
                        if( dt_theme_option('general', 'logo') ):
                            ...
                            <a href="<?php echo esc_url(home_url());?>" title="<?php bloginfo('title'); ?>">
                                <img class="normal_logo" src="<?php echo esc_url($url);?>" alt="<?php bloginfo('title'); ?>" title="<?php bloginfo('title'); ?>" style="width: 125px !important; height: 77px !important;"/>
					...
					<div class="main-menu-container">
                    	<div class="main-menu">
                            <div id="primary-menu">
                                <div class="dt-menu-toggle" id="dt-menu-toggle"><?php _e('Menu','fitnesszone'); ?><span class="dt-menu-toggle-icon"></span></div>
                                <nav id="main-menu">
