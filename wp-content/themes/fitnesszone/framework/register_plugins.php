 ...
 */
if( !function_exists('dt_theme_register_required_plugins') ) {
	function dt_theme_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				...
				'slug'     				=> 'LayerSlider',
				'source'   				=> $template_uri . '/plugins/LayerSlider.zip',
				'version' 				=> '6.7.6',
			),

			array(
				'name'     				=> esc_html__('Slider Revolution', 'fitnesszone'),
				'slug'     				=> 'revslider',
			...
			array(
				'name'     				=> esc_html__('WPBakery Page Builder', 'fitnesszone'),
				'slug'     				=> 'js_composer',
				'source'   				=> $template_uri . '/plugins/js_composer.zip',
				'version' 				=> '5.5.2',
				'required' 				=> false,
			),
			...
			array(
				...
				'slug'     				=> 'envato-market',
				'source'   				=> $template_uri . '/plugins/envato-market.zip',
				'required' 				=> false,
			),
