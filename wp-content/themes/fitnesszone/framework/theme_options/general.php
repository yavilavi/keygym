...
<div id="general" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel"> 
            <li><a href="#my-general"><?php _e("General",'fitnesszone');?></a></li>
            <li><a href="#my-misc"><?php _e("Misc",'fitnesszone');?></a></li>
            <li><a href="#my-sociable"><?php _e("Sociable",'fitnesszone');?></a></li>
            <li><a href="#my-membership"><?php _e("Membership",'fitnesszone');?></a></li>
        </ul>
        ...
        <div id="my-general" class="tab-content">
            ...
            <div class="bpanel-box">
                    <!-- Logo -->
                    <div class="box-title"><h3><?php _e('Logo','fitnesszone');?></h3></div>
					...
					<?php $logo = array(
                            'id'=>		'logo',
                            'options'=>	array(
	'true' => __('Custom Image Logo','fitnesszone'),
	'' =>  __('Display Site Title', 'fitnesszone').' <small><a href="'.esc_url("options-general.php").'">('.__('click here to edit site title', 'fitnesszone').')</a></small>'));
								$output = "";
								$i = 0;
                        ...
                        <div class="column two-fifth last">
                            <p class="note"><?php _e('You can choose whether you wish to display a custom logo or your site title.','fitnesszone');?></p>
                        </div>  
                        <div class="hr"> </div>
                        <div class="clear"></div>
                        
                        <h6><?php _e('Logo','fitnesszone');?></h6>
                        ...
                        <p class="note"> <?php _e('Upload a logo for your theme, or specify the image address of your online logo.','fitnesszone');?> </p>

                        <div class="hr"></div>
                        <div class="clear"></div>
                        <h6><?php _e('Retina Logo','fitnesszone');?></h6>
                        <div class="image-preview-container">
                        ...
                        <p class="note"><?php _e('Upload a retina logo for your theme, or specify the image address of your online logo.','fitnesszone');?></p>
                        <div class="clear"></div>

                        <div class="one-half-content">
                        	<h6><?php _e('Width','fitnesszone');?></h6>
							...
							<?php _e('px','fitnesszone');?>
                        </div>    

                        <div class="one-half-content last">
                        	<h6><?php _e('Height','fitnesszone');?></h6>
                        ...
                        <p class="note"><?php _e('If retina logo is uploaded, enter the standard logo width and height in above respective boxes.','fitnesszone');?></p>
						<div class="clear"></div>
                    ...
                    <!-- Favicon -->
                    <div class="box-title">
                        <h3><?php _e('Favicon','fitnesszone');?></h3>
                    </div>
                    <div class="box-content">
                    	<h6> <?php _e('Enable Favicon','fitnesszone');?> </h6> 
                        ...
                        <div class="hr"></div>
                        <div class="clear"></div>
						<h6><?php _e('Custom Favicon','fitnesszone');?></h6>
                        <div class="image-preview-container">
                            ...
                            <input type="button" value="<?php _e('Upload','fitnesszone');?>" class="upload_image_button" />
                            <input type="button" value="<?php _e('Remove','fitnesszone');?>" class="upload_image_reset" />
                            <?php dt_theme_adminpanel_image_preview(dt_theme_option('general','favicon-url'),false,'favicon.png');?>
                        </div>
                        <p class="note"> <?php _e('Upload a favicon for your theme, or specify the oneline URL for favicon','fitnesszone');?>  </p>
                          
                        <div class="hr"></div>
                        <div class="clear"></div>
                        <h6><?php _e('Apple iPhone Icon','fitnesszone');?></h6>
                        <div class="image-preview-container">
                        ...
                        <p class="note"> <?php _e('Upload your custom iPhone icon (57px by 57px), or specify the oneline URL for favicon','fitnesszone');?>  </p>

                        <div class="hr"></div>
                        <div class="clear"></div>
                        <h6><?php _e('Apple iPhone Retina Icon','fitnesszone');?></h6>
                        <div class="image-preview-container">
                        ...
                        <p class="note"><?php _e('Upload your custom iPhone retina icon (114px by 114px), or specify the oneline URL for favicon','fitnesszone');?></p>

                        <div class="hr"></div>
                        <div class="clear"></div>
                        <h6><?php _e('Apple iPad Icon','fitnesszone');?></h6>
                        <div class="image-preview-container">
                        ...
                        <p class="note"> <?php _e('Upload your custom iPad icon (72px by 72px), or specify the oneline URL for favicon','fitnesszone');?>  </p>

                        <div class="hr"></div>
                        <div class="clear"></div>
                        <h6><?php _e('Apple iPad Retina Icon','fitnesszone');?></h6>
                        <div class="image-preview-container">
                        ...
                        <p class="note"><?php _e('Upload your custom iPad retina icon (144px by 144px), or specify the oneline URL for favicon','fitnesszone');?></p>
                    </div> <!-- Favicon End -->

                    <!-- Others -->
                    <div class="box-title"><h3><?php _e('Others', 'fitnesszone');?></h3></div>
                    <div class="box-content">
                    
                      <h6> <?php _e('Enable Sticky Navigation', 'fitnesszone'); ?></h6>
                      ...
                      <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                            <p class="note no-margin"><?php _e('YES! to enable sticky navigation.','fitnesszone');?> </p>
                        </div>
                        <div class="clear"> </div>
                        <div class="hr"></div>
                    
                   	  <h6> <?php _e('Globally Disable Comments on Pages','fitnesszone');?> </h6>
                      ...
                      <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                            <p class="note no-margin"><?php _e('YES! to disable comments on all the pages. This will globally override your "Allow comments" option under your page "Discussion" settings. ','fitnesszone');?> </p>
                        </div>
                        <div class="hr"></div>
                        
                      <h6><?php _e('Globally Disable Comments on Posts','fitnesszone');?></h6>
                      <div class="column one-fifth">
                   	<?php $checked = ( "true" ==  dt_theme_option('general','global-post-comment') ) ? ' checked="checked"' : ''; ?>
                        ...
                        <div class="column four-fifth last">
                        	<p class="note no-margin"><?php _e('YES! to disable comments on all the posts. This will globally override your "Allow comments" option under your post "Discussion" settings. ','fitnesszone');?> </p>
                        </div>
                        <div class="hr"></div>
                        
                      <h6><?php _e('Globally Disable Comments on Galleries','fitnesszone');?></h6>
                      <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                        	<p class="note"><?php _e('Enable/ Disable comments on gallery pages.','fitnesszone');?> </p>
                        </div>
                        <div class="hr"></div>

                      <h6><?php _e('Globally Disable Comments on Workouts','fitnesszone');?></h6>
                      <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                        	<p class="note"><?php _e('Enable/ Disable comments on workout pages.','fitnesszone');?> </p>
                        </div>
                        <div class="hr"></div>

                      <h6><?php _e('Enable Placeholder Images','fitnesszone');?></h6>
                      <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                        	<p class="note"><?php _e('Enable placeholder images for blog posts.','fitnesszone');?> </p>
                        </div>
                        <div class="hr"></div>

                        <h6><?php _e('Globally Disable Breadcrumbs','fitnesszone');?></h6>
                        <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                        	<p class="note"><?php _e('show / Hide Breacrumbs globally on sitewide','fitnesszone');?> </p>
                        </div>
                        
                        <div class="hr-invisible-small"> </div>
                        
                        <label><?php _e('Breadcrumb Delimiter','fitnesszone');?></label>
                         ...
                         <p class="note"><?php _e('This is the symbol that will appear in between your breadcrumbs','fitnesszone');?></p>   
                         <div class="hr"></div>
                         
                        <h6><?php _e('Disable Style Picker','fitnesszone');?></h6>
                        <div class="column one-fifth">
                        ...
                        <div class="column four-fifth last">
                        	<p class="note"><?php _e('Check if you do not want disable the style picker.','fitnesszone');?> </p>
                        </div>
                        <div class="hr"></div>
                        
                        <h6><?php _e('Google Font Subset','fitnesszone');?></h6>
                        ...
                        <div class="column one-half last">
                            <p class="note no-margin"><?php _e('Paste your mailchimp api key that will be used by the mailchimp widget.','fitnesszone'); ?></p>
                        </div>
        ...
        <div id="my-misc" class="tab-content">
            <!-- .bpanel-box -->
            <div class="bpanel-box">
				<div class="box-title"><h3><?php _e('Top Bar','fitnesszone');?></h3></div>
                <div class="box-content">
                    <h6><?php _e('Disable Top Bar','fitnesszone');?></h6>
                    <div class="column one-fifth">
                    ...
                    <div class="column four-fifth last">
                       <p class="note"><?php _e('YES! to disable header top bar. ','fitnesszone');?> </p>
                    </div>
                    <div class="hr"></div>
                 
                    <h6><?php _e('Top Left Content','fitnesszone');?></h6>
                    <div class="column one-half">
                    ...
                    <div class="column one-half last">
                        <p class="note"><?php _e('Specify top bar left content in above fields.','fitnesszone');?> </p>
                    </div>
                </div>
			</div><!-- .bpanel-box end-->
            <!-- .bpanel-box -->
            <div class="bpanel-box">
				<div class="box-title"><h3><?php _e('Loading Animation','fitnesszone');?></h3></div>
                <div class="box-content">
                    <h6><?php _e('Disable Loader','fitnesszone');?></h6>
                    <div class="column one-fifth">
                    ...
                    <div class="column four-fifth last">
                       <p class="note"><?php _e('YES! to disable animated site loader. ','fitnesszone');?> </p>
                    </div>
                </div>
			</div><!-- .bpanel-box end-->
            <!-- .bpanel-box -->
            <div class="bpanel-box">
				<div class="box-title"><h3><?php _e('Contact Form Question','fitnesszone');?></h3></div>
                <div class="box-content">
                    <h6><?php _e('Disable Question','fitnesszone');?></h6>

                    <div class="column one-fifth">
                        <?php dt_theme_switch("",'general',"disable-cform-question");?>
                    </div>
                    <div class="column four-fifth last">
                        <p class="note"><?php _e( "Disable contact form question option.",'fitnesszone'); ?></p>
                    </div>

                    <div class="clear"></div>
                    <!-- Add / Remove Option -->
                    <div class="cform-question">
                        <a href='' class='add-item'><?php _e('Add Option','fitnesszone');?></a>
                        <?php $options = dt_theme_option("general","options-for-question");
                            ...
                            <div class="general-cform-container">
                                ...
                                <a href='' class='remove-item'><?php _e('Remove','fitnesszone');?></a>
                            </div>
                        <?php } ?>
            ...
            <!-- .bpanel-box -->
            <div class="bpanel-box">
				<div class="box-title"><h3><?php _e('Bottom Bar','fitnesszone');?></h3></div>
                <div class="box-content">
                    <h6><?php _e('Disable Bottom Bar','fitnesszone');?></h6>
                    <div class="column one-fifth">
                    ...
                    <div class="column four-fifth last">
                       <p class="note"><?php _e('YES! to disable footer bottom bar.','fitnesszone');?> </p>
                    </div>
                    <div class="hr"></div>

                    <h6><?php _e('Bottom Phone No','fitnesszone');?></h6>
                    <div class="column one-half">
                    ...
                    <div class="column one-half last">
                        <p class="note"><?php _e('Specify bottom phone no in below footer widgets.','fitnesszone');?> </p>
                    </div>
                </div>
			</div><!-- .bpanel-box end-->
		</div>
        ...
        <div id="my-sociable" class="tab-content">
            ...
            <div class="bpanel-box">
                ...
                <div class="box-title">
                	<h3><?php _e('Sociable','fitnesszone');?></h3>
                </div><!-- .box-title -->

                <div class="box-content">
                    <div class="bpanel-option-set">
                         <h6><?php _e('Show Sociable','fitnesszone');?></h6>
                         ...
                         <input type="button" value="<?php _e('Add New Sociable','fitnesszone');?>" class="black mytheme_add_item" />

                         <div class="column four-fifth last">
                             <p class="note"> <?php _e('Manage Social Network icons list to display','fitnesszone');?> </p>
                         </div>
                    ...
                    <div class="bpanel-option-set">
                        ...
                        <?php $socials = dt_theme_option('social');
                              ...
                              <li id="<?php echo $keys[$i];?>">
                                ...
                                <div class="item-content" style="display: none;">
                                	<span><label><?php _e('Sociable Icon','fitnesszone');?></label>
										<?php echo dt_theme_sociables_selection($keys[$i],$s['icon']);?></span>
                                    <span><label><?php _e('Sociable Link','fitnesszone');?></label>
                        ...
                        <ul class="sample-to-edit" style="display:none;">
                            ...
                            <li>
                            	<!-- .item-bar -->
                            	<div class="item-bar">
                                	<span class="item-title"><?php _e('Sociable','fitnesszone');?></span>
                                    <span class="item-control"><a class="item-edit"><?php _e('Edit','fitnesszone');?></a></span>
                                </div><!-- .item-bar -->
                                <!-- .item-content -->
                                <div class="item-content">                                
                                	<span><label><?php _e('Sociable Icon','fitnesszone');?></label><?php echo dt_theme_sociables_selection();?></span>
                                    <span><label><?php _e('Sociable Link','fitnesszone');?></label><input type="text" class="social-link" /></span>
                                    <div class="remove-cancel-links">
                                        <span class="remove-item"><?php _e('Remove','fitnesszone');?></span>
                                        <span class="meta-sep"> | </span>
                                        <span class="cancel-item"><?php _e('Cancel','fitnesszone');?></span>
        ...
        <div id="my-membership" class="tab-content">
	        ...
	        <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php _e('Membership','fitnesszone');?></h3>
                </div>
                <div class="box-content">

                    <div class="column one-third"><label><?php _e('Currency Symbol','fitnesszone');?></label></div>
                    <div class="column two-third last">
                        ...
                        <p class="note"><?php _e('Please set default currency symbol which will be used in front end display','fitnesszone');?></p>
                    </div>
                    
					<div class="hr_invisible"> </div>
 
                    <div class="column one-third"><label><?php _e('Currency','fitnesszone');?></label></div>
                    <div class="column two-third last">
                        <?php
                        ...
                        <p class="note"><?php _e('Please select your curreny symbol which will be used in s2member for payment.','fitnesszone');?></p>
                    </div>
