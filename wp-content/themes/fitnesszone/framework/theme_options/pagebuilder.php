...
<div id="pagebuilder" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel"> 
            <li><a href="#my-pagebuilder"><?php esc_html_e("Page Builder",'fitnesszone');?></a></li>
        </ul>
        ...
        <div id="my-pagebuilder" class="tab-content">
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php esc_html_e('Page Builder','fitnesszone');?></h3>
                </div>
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
						...
						<h6><?php esc_html_e('Choose any of these post types to activate page builder', 'fitnesszone');?></h6><?php

						//Getting post types...
						$post_types = array( 'post' => 'Post', 'page' => 'Page', 'dt_galleries' => 'Gallery', 'dt_workouts' => 'Workouts');
                    ...
                    <div class="bpanel-option-set">
						 ...
						 ?>
                         <h6><?php esc_html_e('Keep page builder active in above selected post types','fitnesszone'); ?></h6>
                    ...
                    <div class="bpanel-option-set">
						...
						?>
                        <h6><?php esc_html_e('Update page contents for latest page builder', 'fitnesszone'); ?></h6>
                        <input type="button" value="<?php esc_attr_e('Update Content','fitnesszone');?>" class="dt_update_pagebuilder_contents <?php echo $disable_cls; ?>" />
						<p class="note"><?php esc_html_e('Latest page builder update needs your content to be updated. Please click the above button to update it. It may take while please be patient.','fitnesszone');?></p>
                        <div class="hr"></div>
                ...
                <?php } else { ?>
                	...
                	<div class="bpanel-box">
                    	 <div class="bpanel-option-set">
                            <p class="note"><?php esc_html_e('Please activate "DesignThemes Core Features Plugin" to get the Page Builder options.','fitnesszone');?></p>
                        </div>
                    </div>
