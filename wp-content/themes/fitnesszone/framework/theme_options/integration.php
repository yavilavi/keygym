...
<div id="integration" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">   
            <li><a href="#integration-general"><?php _e("General",'fitnesszone');?></a></li>
            <li><a href="#integration-post"><?php _e("Post",'fitnesszone');?></a></li>
            <li><a href="#integration-page"><?php _e("Page",'fitnesszone');?></a></li>
            <li><a href="#integration-gallery"><?php _e("Gallery",'fitnesszone');?></a></li>            
        </ul>
        ...
        <div id="integration-general">
        	<?php $integration_general = array( 
					array(
						"title"=>		__('Add Code Inside the &lt;head&gt','fitnesszone'),
						"tooltip"=>		__('Any code you place here will appear in the head section of every page of your site. This code wrapped between script tags.','fitnesszone'),
						"textarea"=>	"header-code",
						"checkbox"=>	"enable-header-code",
						"label"=>		__('Enable Header Code','fitnesszone')
					),
					array(
						"title"=>		__('Add Code above &lt;/body&gt;','fitnesszone'),
						"tooltip"=>		__('You can paste your Google Analytics or other website tracking codes in this box. This code wrapped between script tags.','fitnesszone'), 
						"textarea"=>	"body-code",
						"checkbox"=>	"enable-body-code",
						"label"=>		__('Enable Body Code','fitnesszone')
					),
					array(
						"title"=> 	__('Custom CSS','fitnesszone'),
						"tooltip"=>		__('Paste your custom CSS code here.','fitnesszone'), 
						"textarea"=>	"custom-css",
						"checkbox"=>	"enable-custom-css",
						"label"=>		__('Enable Custom CSS','fitnesszone')
						
					),
                    array(
                        "title"=>   __('Tracking Code','fitnesszone'),
                        "tooltip"=>     __('Paste your tracking code here.Either enter your Google tracking id (UA-XXXXX-X) or your full Google Analytics tracking Code here. If you want to offer your visitors the option to stop being tracked you can place the shortcode [dt_sc_privacy_google_tracking] somewhere on your site','fitnesszone'), 
                        "textarea"=>    "tracking-code",
                        "checkbox"=>    "enable-tracking-code",
                        "label"=>       __('Enable Tracking Code','fitnesszone')
                ...
                <div class="bpanel-box">
                	...
                	<div class="box-content">
                         ...
                         <div class="column one-fifth">
                             ...
                             value="<?php echo $i_general['checkbox'];?>" <?php checked($i_general['checkbox'],dt_theme_option('integration',$i_general['checkbox'])); ?> />
						</div>
	  ...
	  <?php endforeach;?>
        ...
        <?php $integration_post = array(
					array(
						"title"=>		__('Add code to the top of your posts','fitnesszone'),
						"tooltip"=>		__('Place any codes to show on top of all single post. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','fitnesszone'),
						"textarea"=>	"single-post-top-code", 
						"checkbox"=>	"enable-single-post-top-code",
						"label"=>		__('Enable single post top code','fitnesszone')
					),
					array(
						"title"=>		__('Add code to the bottom of your posts, before the comments','fitnesszone'),
						"tooltip"=>		__('Place any codes to show on bottom of all single post. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','fitnesszone'),
						"textarea"=>	"single-post-bottom-code",
						"checkbox"=>	"enable-single-post-bottom-code",
						"label"=>		__('Enable single post bottom code','fitnesszone')
					));
        ...
        <?php	endforeach;?>
            ...
            <div class="bpanel-box">
                ...
                <div class="box-title">
                    <h3><?php _e("Social Shares",'fitnesszone'); ?></h3>
                </div>
                
                <div class="box-content">
                 <p class="note no-margin"><?php _e("Manage social share options and its layout to show in the blog post.",'fitnesszone')?></p>
                        ...
                        <div class="bpanel-option-set">                        
                         <label><?php echo $social_bookmark["label"];?></label>
                            ...
                            <?php if(array_key_exists("color-scheme",$social_bookmark)): ?>
                                ...
                                <?php _e("Color Scheme",'fitnesszone');?>
                            ...
                            <?php if(array_key_exists("text",$social_bookmark)):?>
                                <div class="clear"></div>
                                <?php _e("Default Text",'fitnesszone');?>
                                <div class="clear"></div>
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php _e("Social Bookmark",'fitnesszone'); ?></h3>
                </div>
                <div class="box-content">
	                <p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the blog post",'fitnesszone')?></p>
                	<?php global $dt_theme_social_bookmarks;
        ...
        <div id="integration-page">
        	<?php $integration_page = array( 
					array(
						"title"=>		__('Add code to the top of your pages','fitnesszone'),
						"tooltip"=>		__('Place any codes to show on top of all single page. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','fitnesszone'),
						"textarea"=>	"single-page-top-code",
						"checkbox"=>	"enable-single-page-top-code",
						"label"=>		__('Enable single page top code','fitnesszone')
					),
					array(
						"title"=>		__('Add code to the bottom of your pages, before the comments','fitnesszone'),
						"tooltip"=>		__('Place any codes to show on bottom of all single page. This is useful if you are looking to integrate things such as social bookmarking links, AD etc.,.','fitnesszone'),
						"textarea"=>	"single-page-bottom-code",
						"checkbox"=>	"enable-single-page-bottom-code",
						"label"=>		__('Enable single page bottom code','fitnesszone')
					)
				);
	  ...
	  <?php endforeach;?>
            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                 ...
                 <p class="note no-margin"><?php _e("Manage social share options and its layout to show in the page.",'fitnesszone')?></p>
            ...
            <!-- .bpanel-box-->
            <div class="bpanel-box">
               <div class="box-title"><h3><?php _e("Social Bookmark",'fitnesszone'); ?></h3></div>
               <div class="box-content">
               	<p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the page.",'fitnesszone')?></p>
               <?php global $dt_theme_social_bookmarks;
        ...
        <div id="integration-gallery">
            ...
            <div class="bpanel-box">
               ...
               <div class="box-content">
               <p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the gallery.",'fitnesszone');?></p>
               <?php global $dt_theme_social_bookmarks;
			   		  unset($dt_theme_social_bookmarks[2], $dt_theme_social_bookmarks[3], $dt_theme_social_bookmarks[6]);
                      $count = 1;
                      foreach($dt_theme_social_bookmarks as $social_bookmark):?>
