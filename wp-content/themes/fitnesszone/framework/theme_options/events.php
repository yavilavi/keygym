...
<div id="events" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">
            <li><a href="#my-events"><?php _e("Events Settings",'fitnesszone');?></a></li>
        </ul>
...
<?php  if( class_exists('Tribe__Events__Main') ) : ?>
				...
				<!-- Events Page -->
            	<div class="box-title"><h3><?php _e('Events','fitnesszone');?></h3></div>
                <div class="box-content">
                	<!-- Events Page Layout -->
                    <h6><?php _e('Layout','fitnesszone');?></h6>
                    <p class="note no-margin"> <?php _e("Choose the Events page layout","fitnesszone");?></p>
                    ...
                    <div id="bpanel-widget-area-options" <?php echo 'class="event-archive-layout" '.$sidebar_both;?>>
                        ...
                        <div id="left-sidebar-container" class="bpanel-page-left-sidebar" <?php echo $sidebar_left; ?>>
                            ...
                            <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                <h6><?php _e('Disable Event Every Where Sidebar Left','fitnesszone');?></label></h6>
                        ...
                        <div id="right-sidebar-container" class="bpanel-page-right-sidebar" <?php echo $sidebar_right; ?>>
                            ...
                            <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                <h6><?php _e('Disable Event Every Where Sidebar Right','fitnesszone');?></label></h6>
				...
				<!-- Event Detail Page -->
            	<div class="box-title"><h3><?php _e('Event Detail','fitnesszone');?></h3></div>
                <div class="box-content">
                	<!-- Event Detail Page Layout -->
                    <h6><?php _e('Layout','fitnesszone');?></h6>
                    <p class="note no-margin"> <?php _e("Choose the Event page layout","fitnesszone");?></p>
                    <div class="hr_invisible"> </div>
                    <div class="bpanel-option-set">
				...
				<!-- Event Category Page -->
            	<div class="box-title"><h3><?php _e('Event Category','fitnesszone');?></h3></div>
                <div class="box-content">
                	<!-- Event Category Page Layout -->
                    <h6><?php _e('Layout','fitnesszone');?></h6>
                    <p class="note no-margin"> <?php _e("Choose the Event category page layout Style","fitnesszone");?></p>
                    <div class="hr_invisible"> </div>
                    <div class="bpanel-option-set">
...
<?php 	else: ?>
                ...
                <div class="box-content"><p class="note"><?php _e("You have to install and activate the TheEventsCalendar plugin to use this module ..",'fitnesszone');?></p></div>
<?php   endif;?>

<?php  if( dt_theme_is_plugin_active('timetable/timetable.php') ) : ?>

				<!-- TT Event Detail Page -->
            	<div class="box-title"><h3><?php _e('Timetable Event Detail','fitnesszone');?></h3></div>
                <div class="box-content">
                	<!-- TT Event Detail Page Layout -->
                    <h6><?php _e('Layout','fitnesszone');?></h6>
                    <p class="note no-margin"> <?php _e("Choose the Timetable Event detail page layout","fitnesszone");?></p>
                    <div class="hr_invisible"> </div>
                    <div class="bpanel-option-set">
                    	<ul class="bpanel-post-layout bpanel-layout-set" id="event-detail-layout">
                        <?php $layout = array('content-full-width'=>'without-sidebar','with-left-sidebar'=>'left-sidebar','with-right-sidebar'=>'right-sidebar','with-both-sidebar'=>'both-sidebar');
                    ...
                    <div id="bpanel-widget-area-options" <?php echo 'class="event-detail-layout" '.$sidebar_both;?>>
                        ...
                        <div id="left-sidebar-container" class="bpanel-page-left-sidebar" <?php echo $sidebar_left; ?>>
                            ...
                            <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                <h6><?php _e('Disable Timetable Event Sidebar Left','fitnesszone');?></label></h6>
                        ...
                        <div id="right-sidebar-container" class="bpanel-page-right-sidebar" <?php echo $sidebar_right; ?>>
                            ...
                            <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                <h6><?php _e('Disable Timetable Event Sidebar Right','fitnesszone');?></label></h6>
...
<?php 	else: ?>
				<div class="box-title"><h3><?php _e('Warning','fitnesszone');?></h3></div>
                <div class="box-content"><p class="note"><?php _e("You have to install and activate the Timetable plugin to use this module ..",'fitnesszone');?></p></div>
<?php   endif;?>
