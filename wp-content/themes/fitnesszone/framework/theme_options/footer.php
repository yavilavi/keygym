...
<div id="theme-footer" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel"> 
            <li><a href="#my-footer"><?php _e("Footer",'fitnesszone');?></a></li>
        </ul>
        ...
        <div id="my-footer" class="tab-content">
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php _e('Footer','fitnesszone');?></h3>
                </div>
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                         ...
                         <h6><?php _e('Show Footer','fitnesszone');?></h6>
                        ...
                        <h6><?php _e('Footer Column Layout','fitnesszone');?></h6>
                        <p class="note"><?php _e("Select a perfect column layout style for your theme's footer.",'fitnesszone');?></p>
                        ...
                        <?php foreach($footer_layouts as $k => $v): $class = ( $k ==  dt_theme_option('general','footer-columns')) ? " class='selected' " : "";?>
                       		<li><a href="#" rel="<?php echo $k;?>" <?php echo $class;?>><img src="<?php echo FITNESSZONE_FW_URL."theme_options/images/columns/{$v}.png";?>" /></a></li>	
                        <?php endforeach;?>
                    ...
                    <div class="bpanel-option-set">
                         <h6><?php _e('Show Copyright Text','fitnesszone');?></h6>
                        ...
                        <h6><?php _e('Copyright Text','fitnesszone');?></h6>
                        ...
                        <p class="note"> <?php _e('You can paste your copyright text in this box. This will be automatically added to the footer.','fitnesszone');?> </p>
                    </div><!-- .bpanel-option-set -->
