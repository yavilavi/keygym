...
class MY_Gallery_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(false,FITNESSZONE_THEME_NAME.__(' Gallery','fitnesszone'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-gallery-widget'><ul>";
			 ...
			 while($the_query->have_posts()):
				...
				echo "<li>";
					if(1 == $_enabled_image):
						...
						$image = ( $image != false)? $image[0]:FITNESSZONE_BASE_URL."/images/dummy-images/poster-my-post-thumb.jpg";
			 ...
			 endwhile;
			 	...
			 	echo "<li>".__('No Gallery Entries found','fitnesszone')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
		echo $after_widget;
