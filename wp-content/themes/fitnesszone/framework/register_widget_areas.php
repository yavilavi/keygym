<?php
	...
	register_sidebar(array(
		'name' 			=>	__('Standard Left Sidebar', 'fitnesszone'),
		'id'			=>	'display-everywhere-sidebar-left',
		'description'	=>	__("Common sidebar that appears left hand side once enabled.","fitnesszone"),
	...
	register_sidebar(array(
		'name' 			=>	__('Standard Right Sidebar', 'fitnesszone'),
		'id'			=>	'display-everywhere-sidebar-right',
		'description'	=>	__("Common sidebar that appears right hand side once enabled.","fitnesszone"),
		'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
		'after_widget' 	=> 	'</aside>',
		'before_title' 	=> 	'<div class="widgettitle"><h3>',
		'after_title' 	=> 	'</h3></div>'));
    ...
    foreach ($custom_widgetarea as $key => $value) {
		...
		'name' 			=>	$value,
		'id'			=>	$id,
		'description'   =>  __("A unique sidebar that is created in Admin panel for custom sidebar","fitnesszone"),
		'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
		'after_widget' 	=> 	'</aside>',
		'before_title' 	=> 	'<div class="widgettitle"><h3>',
		'after_title' 	=> 	'</h3></div>'));
	...
	if( class_exists('Tribe__Events__Main')	):
		#Left Sidebar
		register_sidebar(array(
			'name' 			=>	__('Events Everywhere Left', 'fitnesszone'),
			'id'			=>	'events-everywhere-sidebar-left',
			'description'   =>  __("Events page unique sidebar that appears on the left.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
		...
		#Right Sidebar
		register_sidebar(array(
			'name' 			=>	__('Events Everywhere Right', 'fitnesszone'),
			'id'			=>	'events-everywhere-sidebar-right',
			'description'   =>  __("Events page unique sidebar that appears on the right.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	if( class_exists('woocommerce')	):
		#Left Sidebar
		register_sidebar(array(
			'name' 			=>	__('Shop Everywhere Left', 'fitnesszone'),
			'id'			=>	'shop-everywhere-sidebar-left',
			'description'   =>  __("Shop page unique sidebar that appears on the left.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
		...
		#Right Sidebar
		register_sidebar(array(
			'name' 			=>	__('Shop Everywhere Right', 'fitnesszone'),
			'id'			=>	'shop-everywhere-sidebar-right',
			'description'   =>  __("Shop page unique sidebar that appears on the right.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	if( dt_theme_is_plugin_active('timetable/timetable.php') ):
		...
		#Left Sidebar
		register_sidebar(array(
			'name' 			=>	__('TT Event Sidebar Left', 'fitnesszone'),
			'id'			=>	'tt-event-sidebar-left',
			'description'   =>  __("Timetable event unique sidebar that appears on the left.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
		...
		#Right Sidebar
		register_sidebar(array(
			'name' 			=>	__('TT Event Sidebar Right', 'fitnesszone'),
			'id'			=>	'tt-event-sidebar-right',
			'description'   =>  __("Timetable event unique sidebar that appears on the right.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	if( $post_archives_layout != "content-full-width" ){
		if( $post_archives_layout == "with-left-sidebar" || $post_archives_layout == "with-both-sidebar" ){
			register_sidebar(array(
				'name' 			=>	__("Post Archives Sidebar Left",'fitnesszone'),
				'id'			=>	'post-archives-sidebar-left',
				'description'   =>  __("Tag archives sidebar that appears on the left.","fitnesszone"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<div class="widgettitle"><h3>',
				'after_title' 	=> 	'</h3></div>'));
		...
		if( $post_archives_layout == "with-right-sidebar" || $post_archives_layout == "with-both-sidebar"){
			register_sidebar(array(
				'name' 			=>	__("Post Archives Sidebar Right",'fitnesszone'),
				'id'			=>	'post-archives-sidebar-right',
				'description'   =>  __("Tag archives sidebar that appears on the right.","fitnesszone"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<div class="widgettitle"><h3>',
				'after_title' 	=> 	'</h3></div>'));
	...
	if( dt_theme_is_plugin_active('designthemes-core-features/designthemes-core-features.php') ):
		...
		if( $gallery_archives_layout != "content-full-width" ){
			if( $gallery_archives_layout == "with-left-sidebar" || $gallery_archives_layout == "with-both-sidebar" ){
				register_sidebar(array(
					'name' 			=>	__("Gallery Archives Sidebar Left",'fitnesszone'),
					'id'			=>	'custom-post-gallery-archives-sidebar-left',
					'description'   =>  __("Gallery archives sidebar that appears on the left.","fitnesszone"),
					'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> 	'</aside>',
					'before_title' 	=> 	'<div class="widgettitle"><h3>',
					'after_title' 	=> 	'</h3></div>'));
			...
			if( $gallery_archives_layout == "with-right-sidebar" || $gallery_archives_layout == "with-both-sidebar"){
				register_sidebar(array(
					'name' 			=>	__("Gallery Archives Sidebar Right",'fitnesszone'),
					'id'			=>	'custom-post-gallery-archives-sidebar-right',
					'description'   =>  __("Gallery archives sidebar that appears on the right.","fitnesszone"),
					'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> 	'</aside>',
					'before_title' 	=> 	'<div class="widgettitle"><h3>',
					'after_title' 	=> 	'</h3></div>'));
	...
	if( $search_layout != "content-full-width" ){
		if( $search_layout == "with-left-sidebar" || $search_layout == "with-both-sidebar" ){
			register_sidebar(array(
				'name' 			=>	__("Search Sidebar Left",'fitnesszone'),
				'id'			=>	'search-sidebar-left',
				'description'   =>  __("Search page sidebar that appears on the left.","fitnesszone"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<div class="widgettitle"><h3>',
				'after_title' 	=> 	'</h3></div>'));
		...
		if( $search_layout == "with-right-sidebar" || $search_layout == "with-both-sidebar"){
			register_sidebar(array(
				'name' 			=>	__("Search Sidebar Right",'fitnesszone'),
				'id'			=>	'search-sidebar-right',
				'description'   =>  __("Search page sidebar that appears on the right.","fitnesszone"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<div class="widgettitle"><h3>',
				'after_title' 	=> 	'</h3></div>'));
	...
	if( $layout_404 != "content-full-width" ){
		if( $layout_404 == "with-left-sidebar" || $layout_404 == "with-both-sidebar" ){
			register_sidebar(array(
				'name' 			=>	__('Not Found ( 404 ) Sidebar Left','fitnesszone'),
				'id'			=>	'not-found-404-sidebar-left',
				'description'   =>  __("404 page sidebar that appears on the left.","fitnesszone"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<div class="widgettitle"><h3>',
				'after_title' 	=> 	'</h3></div>'));
		...
		if( $layout_404 == "with-right-sidebar" || $layout_404 == "with-both-sidebar"){
			register_sidebar(array(
				'name' 			=>	__('Not Found ( 404 ) Sidebar Right','fitnesszone'),
				'id'			=>	'not-found-404-sidebar-right',
				'description'   =>  __("404 page sidebar that appears on the right.","fitnesszone"),
				'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> 	'</aside>',
				'before_title' 	=> 	'<div class="widgettitle"><h3>',
				'after_title' 	=> 	'</h3></div>'));
    ...
    foreach ($widgets as $key => $value) {
    	...
    	register_sidebar(array(
			'name' 			=>	$value,
			'id'			=>	$id,
			'description'   =>  __("A unique mega menu sidebar that is created in Admin panel","fitnesszone"),
...
if( class_exists('woocommerce')	):
	...
	foreach($widget_areas_for_products as $id):
		...
		register_sidebar(array(
			...
			'description'	=> __("Individual product sidebar that appears on the left.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	foreach($widget_areas_for_products as $id):
		...
		register_sidebar(array(
			...
			'description'	=> __("Individual product sidebar that appears on the right.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	foreach($widget_areas_for_product_categories as $id):
		...
		register_sidebar(array(
			...
			'description'	=> __("Individual product category sidebar that appears on the left.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	foreach($widget_areas_for_product_categories as $id):
		...
		register_sidebar(array(
			...
			'description'	=> __("Individual product category sidebar that appears on the right.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	foreach($widget_areas_for_product_tags as $id):
		...
		register_sidebar(array(
			...
			'description'	=> __("Individual product tag sidebar that appears on the left.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
	...
	foreach($widget_areas_for_product_tags as $id):
		...
		register_sidebar(array(
			...
			'description'	=> __("Individual product tag sidebar that appears on the right.","fitnesszone"),
			'before_widget' => 	'<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> 	'</aside>',
			'before_title' 	=> 	'<div class="widgettitle"><h3>',
			'after_title' 	=> 	'</h3></div>'));
