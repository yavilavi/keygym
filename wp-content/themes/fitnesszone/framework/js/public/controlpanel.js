...
$patterns = "";
var $rtl = mytheme_urls.isRTL;

for(var i=1; i<= 10; i++){
	$img = mytheme_urls.theme_base_url + "images/style-picker/pattern"+i+".jpg";
	$patterns += '<li>';
...
$str += '       	<li> <a id="fullwidth" href="" title="" class="selected"> <img src="' + mytheme_urls.theme_base_url + 'images/style-picker/fullwidth.jpg" alt="Fullwidth" width="71" height="49" /> </a> </li>';
$str += '       	<li> <a id="boxed" href="" title=""> <img src="' + mytheme_urls.theme_base_url + 'images/style-picker/boxed.jpg" alt="Boxed" width="71" height="49" /> </a> </li>';
$str += '		</ul>';
$str += '       <h3> Choose your Scheme </h3>';
$str += '		<ul class="scheme-picker">';
$str += '       	<li> <a id="light" href="" title="" class="selected"> <img src="' + mytheme_urls.theme_base_url + 'images/style-picker/light.png" alt="Light" width="41" height="11" /> </a> </li>';
$str += '       	<li> <a id="dark" href="" title=""> <img src="' + mytheme_urls.theme_base_url + 'images/style-picker/dark.png" alt="Dark" width="39" height="10" /> </a> </li>';
$str += '		</ul>';
...
jQuery(document).ready(function($){
	...
	if($.cookie("fitnesstheme_skin")!= null){
		var $href = mytheme_urls.theme_base_url + 'skins/' + $.cookie("fitnesstheme_skin")+"/style.css";
	...
	if($.cookie("fitnesstheme_scheme") != null){
		...
		if( $.cookie("fitnesstheme_scheme") === "dark" ) {
			$("<link id='light-dark-css' href='"+ mytheme_urls.theme_base_url +"dark/dark-skin.css' rel='stylesheet' media='all' />").insertBefore($('#skin-css'));
	...
	$("ul.layout-picker a").click(function(e){
		...
		if( $.cookie("fitnesstheme_layout") === "boxed") {
			...
			if( $.cookie("fitnesstheme_pattern") == null ){
				...
				$("ul.pattern-picker a[id="+$.cookie("fitnesstheme_pattern")+"]").addClass('selected');
				$img = mytheme_urls.theme_base_url + "images/patterns/"+$.cookie("fitnesstheme_pattern")+".jpg";
