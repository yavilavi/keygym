<?php
	...
	if( !function_exists('post_metabox') ) {
		function post_metabox(){
			add_meta_box("post-template-meta-container", __('Post Options','fitnesszone'), "post_settings","post", "normal", "default");
			add_meta_box("post-format-meta-container",__('Post Format Options','fitnesszone'),"post_format_settings","post","normal","default");			
			add_action('save_post','post_meta_save');
		}
	}
	
	if( !function_exists('post_settings') ) {
		function post_settings($args){
			...
			<div id="page-layout" class="custom-box">
				<div class="column one-sixth">                        
					<label><?php _e('Layout','fitnesszone');?> </label>
				</div>
			...
			<div class="custom-box">
				<div class="column one-sixth">                        
					<label><?php _e('Disable Comments','fitnesszone');?></label>
				</div>
				<div class="column five-sixth last">  
					...
					<p class="note"> <?php _e('YES! to disable Comments.','fitnesszone');?> </p>
				</div>	
			...
			<div class="custom-box">
				<div class="column one-sixth">                        
					<label><?php _e('Disable Featured Image','fitnesszone');?></label>
				</div>
				<div class="column five-sixth last">  
					...
					<p class="note"> <?php _e('YES! to disable featured image','fitnesszone');?> </p>
				</div>
			...
			<div class="custom-box">
				...
				<?php $post_meta = array(array(
					...
					array(
						...
						"label"=>	__("Disable the comment info.",'fitnesszone'),
						"tooltip"=>	__("By default the comment info will display when viewing your posts. You can choose to disable it here.",'fitnesszone')
					),
					array(
						"id"=>		"disable-category-info",
						"label"=>	__("Disable the category info.",'fitnesszone'),
						"tooltip"=>	__("By default the category info will display when viewing your posts. You can choose to disable it here.",'fitnesszone')
					),
					array(
						"id"=>		"disable-tag-info",
						"label"=>	__("Disable the tag info.",'fitnesszone'),
						"tooltip"=>	__("By default the tag info will display when viewing your posts. You can choose to disable it here.",'fitnesszone')
					));
				$count = 1;
    ...
    if( !function_exists('post_format_settings') ) {
		function post_format_settings( $args ) {
			...
			<div id="dt-post-format-gallery">
				<div class="custom-box">
					<div class="column one-sixth"><label><?php _e('Image Gallery','fitnesszone');?> </label></div>
					<div class="column five-sixth last">
						<div class="dt-media-btns-container">
							<a href="#" class="dt-open-media-for-gallery-post button button-primary">
								<?php _e( 'Click Here to Add Images', 'fitnesszone' );?> </a>
						</div>
						<div class="clear"></div>
			...
			<div id="dt-post-format-video-audio">
				<div class="custom-box">
					<div class="column one-sixth"><label><?php _e('oEmbed URL','fitnesszone');?> </label></div>
					<div class="column five-sixth last">
						...
						<p class="note"><?php _e("Enter a URL that is compatible with WP's built-in oEmbed feature. This setting is used for your video and audio post formats.",'fitnesszone');?></p>
					</div>
				</div>
	
				<div class="custom-box">
					<div class="column one-sixth"><label><?php _e('Self Hosted URL','fitnesszone');?> </label></div>
					<div class="column five-sixth last">
						...
						<p class="note"><?php _e("Insert your self hosted video or audio url here.",'fitnesszone');?></p>                    
					</div>
				</div>
			</div><?php
		}
	...
	if( !function_exists('post_meta_save') ) {
