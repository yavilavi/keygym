<?php get_header();
      ...
      <div class="breadcrumb-wrapper">
          <div class="container">
              <h1><?php _e('Lost', 'fitnesszone'); ?></h1><?php
              ...
              <div class="container">
                  ...
                  <?php endif; ?>
                    ...
                    <article class="error-404 aligncenter">
                        ...
                        <a href="<?php echo esc_url(home_url('/'));?>" class="dt-sc-button medium"><span data-hover="<?php _e('Back to Home', 'fitnesszone'); ?>"><?php _e('Back to Home', 'fitnesszone'); ?></span></a>
                    </article>
                  </section>
