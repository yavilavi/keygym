              ...
              <div class="container">
                  ...
                  <?php endif;
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-entry blog-single-entry'); ?>>
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-metadata"><?php
								#Sticky...
								if(is_sticky()): ?>
                                	<div class="featured-post"><span><?php _e('Featured','fitnesszone'); ?></span></div>
								...
								the_content();
								wp_link_pages(array('before' => '<div class="page-link"><strong>'.__('Pages:', 'fitnesszone').'</strong> ', 'after' => '</div>', 'next_or_number' => 'number'));
								edit_post_link(__('Edit', 'fitnesszone'), '<span class="edit-link">', '</span>' );
                    ...
                    <div class="author-info">
                        <h2 class="section-title"><?php _e('About the Author', 'fitnesszone'); ?></h2>
                        <div class="thumb">
                        ...
                        <div class="author-desc">
                            <div class="author-title"><?php
                                ...
                                <p><?php _e('By', 'fitnesszone'); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta('ID')); ?>"><?php echo $user_info->user_login; ?></a> / <?php echo ucfirst(implode(', ', $user_info->roles)); ?> <span><?php _e('on', 'fitnesszone'); echo get_the_date(' M d, Y'); ?></span></p>
                                <span><i class="fa fa-twitter"></i><a href="https://twitter.com/<?php echo $user_info->user_nicename; ?>"><?php _e('Follow ', 'fitnesszone'); echo $user_info->user_nicename; ?></a></span>
                            </div>
